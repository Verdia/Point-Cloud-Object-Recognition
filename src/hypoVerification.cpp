...
CloudStyle style_blue (0.0, 0.0, 255.0, 5.0);
      ...
      char *argv[])
{
  ...
  {
    std::cout << "Recognized Pose Instances: " << rototranslations.size () << std::endl << std::endl;
  }
   ...
   *  Visualization
   */
  pcl::visualization::PCLVisualizer viewer ("Pose Estimation Object Surface");
  ...
  for (std::size_t i = 0; i < instances.size (); ++i)
  {
    ...
    CloudStyle registeredStyles = hypotheses_mask[i] ? style_blue : style_blue;
